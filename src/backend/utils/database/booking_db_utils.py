...
from ...models.business.booking_model import ServiceBooking, BusinessBooking, StaffBooking
...
class BookingDBUtils:
    ...
    def get_booking_by_id(self, booking_id: str) -> Union[ServiceBooking, BusinessBooking, StaffBooking]:
        try:
